...
export default function Sidebar({ isCollapsed = true, onToggle, onHoverChange }: SidebarProps) {
  ...
  const getNavItems = (): NavItem[] => {
    ...
    // Mostrar Avisos solo para administradores (ANTES que Comunidades)
    ...
    if (canManageAnnouncements) {
      console.log('✅ [Sidebar] Agregando módulo Avisos');
      baseItems.push({
        name: 'Avisos',
      ...
      console.log('❌ [Sidebar] NO agregando módulo Avisos - Sin permisos de administrador');
    }
